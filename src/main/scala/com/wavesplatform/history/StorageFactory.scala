...
object StorageFactory {
  ...
  def apply(settings: BlockchainSettings, ds: DataSource): Try[(NgHistory with DebugNgHistory with AutoCloseable, StateWriter, StateReader, BlockchainUpdater, BlockchainDebugInfo)] = {
